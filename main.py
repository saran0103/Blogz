...
def login():
    ...
    if request.method == 'POST':
        ...
        if not username and not password:
            ...
            title = "Login Page", username_error="Please enter valid Username",
            password_error="Please enter password")

        if(username_error_flag == True or password_error_flag == True):
            return render_template('login.html', 
            title = "Login Page", username_error=username_error,
            password_error=password_error,username = username, password =password)
...
def signup():
    if request.method == 'POST':
        ...
        if password == "":
            ...
            validity_check = True
        elif password != verify or verify == "":
            verify_error = "Passwords do not match."
            validity_check = True
        if exist:
            username_error = "Username already taken."
            return render_template('signup.html', 
            title = "Signup Page", username_error=username_error)
        ...
        if not username and not password:
            return render_template('signup.html', 
            title = "Signup Page", username_error="Please enter valid Username",
            password_error="Please enter password and verify")
